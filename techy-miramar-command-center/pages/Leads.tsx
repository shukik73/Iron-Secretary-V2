  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <h1 className="text-4xl font-bold text-white tracking-tight">Leads & Repairs</h1>
                    ...
                    {leads.map(lead => (
                        <tr key={lead.id} className="border-b border-gray-800/50 last:border-0 hover:bg-gray-800/50">
                            ...
                            <td className="py-3 text-right">
                                <button className="text-gray-500 hover:text-white" aria-label={`Message ${lead.name}`}>
